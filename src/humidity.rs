...
impl<T: Temperature> TemperatureAndRelativeHumidity<T> {
    ...
    pub fn dew_point(&self) -> T {
        const M: f32 = 17.62;
        const TN: f32 = 243.12;
        let val = f32::ln(self.relative_humidity / 100.0)
...
mod tests {
    ...
    #[rstest]
    #[case(TemperatureAndRelativeHumidity{ temperature: Celsius(21.18), relative_humidity: 45.59 }, 8.43)]
    #[case(TemperatureAndRelativeHumidity{ temperature: Fahrenheit(70.12), relative_humidity: 45.59 }, 8.43)]
    #[case(TemperatureAndRelativeHumidity{ temperature: Celsius(2.93), relative_humidity: 34.71 }, 2.06)]
    #[case(TemperatureAndRelativeHumidity{ temperature: Fahrenheit(107.7), relative_humidity: 74.91 }, 42.49)]
    ...
    #[rstest]
    #[case(TemperatureAndRelativeHumidity{ temperature: Celsius(21.18), relative_humidity: 45.59 }, Celsius(8.96))]
    #[case(TemperatureAndRelativeHumidity{ temperature: Fahrenheit(70.12), relative_humidity: 45.59 }, Fahrenheit(48.13))]
    #[case(TemperatureAndRelativeHumidity{ temperature: Celsius(2.93), relative_humidity: 34.71 }, Celsius(-11.16))]
    #[case(TemperatureAndRelativeHumidity{ temperature: Fahrenheit(107.7), relative_humidity: 74.91 }, Fahrenheit(98.01))]
    ...
    #[rstest]
    #[case(TemperatureAndRelativeHumidity{ temperature: Celsius(21.18), relative_humidity: 45.59 }, TemperatureAndRelativeHumidity{ temperature: Fahrenheit(70.12), relative_humidity: 45.59 })]
    #[case(TemperatureAndRelativeHumidity{ temperature: Celsius(-7.49), relative_humidity: 73.19 }, TemperatureAndRelativeHumidity{ temperature: Fahrenheit(18.52), relative_humidity: 73.19 })]
    ...
    #[rstest]
    #[case(TemperatureAndRelativeHumidity{ temperature: Fahrenheit(70.12), relative_humidity: 45.59 }, TemperatureAndRelativeHumidity{ temperature: Celsius(21.18), relative_humidity: 45.59 })]
    #[case(TemperatureAndRelativeHumidity{ temperature: Fahrenheit(18.52), relative_humidity: 73.19 }, TemperatureAndRelativeHumidity{ temperature: Celsius(-7.49), relative_humidity: 73.19 })]
